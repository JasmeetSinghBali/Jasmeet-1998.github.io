...
//to make Google Books API request
...
function App() {
  ...
  //Handling Search Submit button logic
  const handleSubmit=()=>{
    setLoading(true);
    if(maxResults>40 || maxResults<1){
      toast.error('max results allowed between 1 to 40 only');
    }else{
...
=======
              placeholder='Book Search' value={query} onChange={e=>setQuery(e.target.value)}/>
            <InputGroupAddon addonType='append'>
...
=======
  ...
  //Handle fetched data from Google Book API
  const handleCards=()=>{
    console.log(cards)
